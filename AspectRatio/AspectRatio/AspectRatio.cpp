...
// AspectRatio.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CAspectRatioApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CAspectRatioApp

CAspectRatioApp::CAspectRatioApp()
{
...
// Единственный объект CAspectRatioApp

CAspectRatioApp theApp;


// Инициализация CAspectRatioApp

BOOL CAspectRatioApp::InitInstance()
{
